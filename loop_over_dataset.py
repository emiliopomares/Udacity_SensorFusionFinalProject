...
#10963653239323173269_1924_000_1944_000

data_filename = 'training_segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord' # Sequence 2
if PROJECT_PART == 2 and (STEP == 1 or STEP == 2):
    data_filename = 'training_segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord' # Sequence 2
if PROJECT_PART == 2 and (STEP == 3 or STEP == 4):
    data_filename = 'training_segment-1005081002024129653_5313_150_5333_150_with_camera_labels.tfrecord' # Sequence 1
if PROJECT_PART == 2 and STEP > 4:
...
if STEP == 3 or STEP == 4:
    show_only_frames = [0, 200]
if STEP == 5:
    show_only_frames = [0, 150]

## Prepare Waymo Open Dataset file for loading
data_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'dataset', data_filename) # adjustable path in case this script is called from another working directory
results_path = 'results'
if STEP > 4:
    results_path = 'results_A' # Results from Part 1 of the Project
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), results_path)
...
exec_detection = [] #'pcl_from_rangeimage', 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] #'pcl_from_rangeimage', 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] # options are 'bev_from_pcl', 'pcl_from_rangeimage', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file
exec_tracking = ['perform_tracking']
exec_visualization = ['show_tracks']
if STEP == 1 or STEP == 2 or STEP == 3 or STEP > 4:
    exec_tracking = ['perform_tracking']
if STEP == 1 or STEP == 2 or STEP == 3 or STEP > 4:
    exec_visualization = ['show_tracks'] #'show_detection_performance'] #'show_detection_performance'] # options are 'show_range_image', 'show_bev', 'show_pcl', 'show_labels_in_image', 'show_objects_and_labels_in_bev', 'show_objects_in_bev_labels_in_camera', 'show_tracks', 'show_detection_performance', 'make_tracking_movie'
if STEP == 4:
        ...
        if 'perform_tracking' in exec_list:
            ...
            if 'show_tracks' in exec_list:
                ...
                if 'make_tracking_movie' in exec_list:
                    ...
                    fname = results_fullpath + '/tracking_%03d.png' % cnt_frame
