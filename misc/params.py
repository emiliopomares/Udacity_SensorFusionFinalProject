...
window = 12 # number of frames for track score calculation TWEAKED
...
if FINE_TUNE:
    sigma_p44 = 100# initial setting for estimation error covariance P entry for vx
    sigma_p55 = 25 # initial setting for estimation error covariance P entry for vy
    sigma_p66 = 5 # initial setting for estimation error covariance P entry for vz
    q = 1.8
    max_P = 0.7**2 # delete track if covariance of px or py bigger than this
...
if FINE_TUNE: # sigmas from previous project
    sigma_lidar_x = 0.0776 # measurement noise standard deviation for lidar x position   
    sigma_lidar_y = 0.049 # measurement noise standard deviation for lidar y position   
    sigma_lidar_z = 0.1 # measurement noise standard deviation for lidar z position        
    sigma_cam_i = 2.4 # measurement noise standard deviation for image i coordinate
    sigma_cam_j = 1 # measurement noise standard deviation for image j coordinate
